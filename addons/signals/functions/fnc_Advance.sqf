...
*
* Example:
* [] call kolmi_fnc_signals_Advance;
*
* Public: No
*/
...
private _text = format["ADVANCE <br/><t size='0.7'>%1</t>", _playerName];
...
{
    [_text, QPATHTOF(img\MoveAdvance.paa), [1, 1, 1], _x, 2] call ace_common_fnc_displayTextPicture;
